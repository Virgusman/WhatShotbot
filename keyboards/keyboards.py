...
ingame_gb: ReplyKeyboardMarkup = ReplyKeyboardMarkup(keyboard=[[button_4],[button_2]], resize_keyboard=True, one_time_keyboard=False)

#Клавиатура для админа в игре В ИГРЕ
adminingame_gb: ReplyKeyboardMarkup = ReplyKeyboardMarkup(keyboard=[[button_4],[button_2],[button_3]], resize_keyboard=True, one_time_keyboard=False)